...
pub const _YELLOW: Color = Color::Rgb { r:181, g:137, b:0 };
pub const _ORANGE: Color = Color::Rgb { r:203, g:75, b:22 };
pub const _RED: Color = Color::Rgb { r:211, g:1, b:2 };
pub const _MAGENTA: Color = Color::Rgb { r:211, g:54, b:130 };
